...
/* #undef ENABLE_JIT_TRANSLATION */

/* Define to enable preemptive multitasking of Smalltalk processes */
/* #undef ENABLE_PREEMPTION */

/* The relative path from the program to the exec_prefix. Defined only for
...
/* Define to the #include directive for GLUT. */
/* #undef GL_GLUT_H */

/* Define to the #include directive for OpenGL glu functions. */
#define GL_GLU_H <OpenGL/glu.h>

/* Define to the #include directive for OpenGL. */
...
/* Define if your system has GLUT installed. */
/* #undef HAVE_GLUT */

/* Define to 1 if you have the <GLUT/freeglut.h> header file. */
/* #undef HAVE_GLUT_FREEGLUT_H */

/* Define to 1 if you have the <GLUT/glut.h> header file. */
#define HAVE_GLUT_GLUT_H 1

/* Define to 1 if you have the <GL/freeglut.h> header file. */
/* #undef HAVE_GL_FREEGLUT_H */
...
/* Define to 1 if you have the `g_poll' function. */
#define HAVE_G_POLL 1
...
/* Define to 1 if you have the `SDL_sound' library (-lSDL_sound). */
/* #undef HAVE_LIBSDL_SOUND */
...
/* Define if your system has OpenGL installed. */
...
/* Define if your system has sockets. */
...
#define HOST_SYSTEM "x86_64-apple-darwin21.6.0"

/* Define as const if the declaration of iconv() needs const. */
#define ICONV_CONST 

/* The relative path from the program to the image path. Defined only for
   relocatable installs. */
#define IMAGE_PATH "/usr/local/var/lib"

/* The relative path from the program to the kernel path. Defined only for
   relocatable installs. */
#define KERNEL_PATH "/usr/local/var/lib"

/* The relative path from the program to the per-package libexec path. Defined
   only for relocatable installs. */
#define LIBEXEC_PATH "/usr/local/libexec"
...
#define MAINTAINER "bonzini@gnu.org"

/* The relative path from the program to the module path. Defined only for
   relocatable installs. */
#define MODULE_PATH "/usr/local/lib"
...
#define PACKAGE_BUGREPORT "help-smalltalk@gnu.org"

/* The git version that GNU Smalltalk was compiled from. */
#define PACKAGE_GIT_REVISION "-5c4a2e13"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GNU Smalltalk"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GNU Smalltalk 3.2.92"
...
#define PACKAGE_VERSION "3.2.92"

/* The relative path from the program to the prefix. Defined only for
   relocatable installs. */
...
/* The size of `OOP', as computed by sizeof. */
#define SIZEOF_OOP 8
...
/* Define to poll if your glib does not provide g_poll. */
/* #undef g_poll */
...
/* #undef rl_filename_completion_function */

/* Define to username_completion_function if you have an older readline */
/* #undef rl_username_completion_function */
