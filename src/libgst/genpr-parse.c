...
{
       0,     0,     3,     4,    11,    12,    13,    18,    21,    24,
      27,    28,    32,    34,    38,    42,    44,    45,    51,    54,
      55,    56
};
...
{
      19,     0,    -1,    -1,    19,    21,    11,    20,    30,    12,
      -1,    -1,    -1,     3,     6,    22,    23,    -1,    24,    25,
      -1,    15,    27,    -1,    14,     5,    -1,    -1,     7,    26,
       8,    -1,     6,    -1,    26,    13,     6,    -1,    27,    13,
      28,    -1,    28,    -1,    -1,     4,     6,    29,    24,    25,
      -1,    30,    31,    -1,    -1,    -1,     4,     9,     6,    32,
      10,    -1
};
...
{
  "$end", "error", "$undefined", "\"primitive\"", "\"prim_id\"",
  "\"number\"", "\"identifier\"", "'['", "']'", "'('", "')'", "'{'", "'}'",
  "','", "'='", "':'", "LITERAL", "WSPACE", "$accept", "input", "@1",
  "primitive_decl", "@2", "primitive_decl_2", "primitive_number",
  "primitive_attrs", "primitive_attr_list", "prim_id_decls",
  "prim_id_decl", "@3", "body", "prim_id_ref", "@4", 0
};
#endif
...
{
       0,    18,    20,    19,    19,    22,    21,    23,    23,    24,
      24,    25,    26,    26,    27,    27,    29,    28,    30,    30,
      32,    31
};
...
{
       4,     0,     1,     0,     0,     5,     2,    10,    19,     0,
       0,     6,     0,     0,     9,     0,     8,    15,     0,     7,
       0,     3,    18,    16,     0,    12,     0,     0,    10,    14,
      11,     0,    20,     0,    13,     0,    17,    21
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     8,     4,     7,    11,    12,    19,    26,    16,
      17,    28,    13,    22,    35
};
...
{
     -13,     2,   -13,     1,    -2,   -13,   -13,   -11,   -13,     5,
       7,   -13,     6,    -4,   -13,     8,    -1,   -13,     9,   -13,
      10,   -13,   -13,   -13,     7,   -13,    -7,    11,     4,   -13,
     -13,    14,   -13,     6,   -13,    12,   -13,   -13
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -13,   -13,   -13,   -13,   -13,   -13,   -12,   -10,   -13,   -13,
      -3,   -13,   -13,   -13,   -13
};
...
{
      20,    30,     2,     9,    10,     3,    31,     5,    21,     6,
      14,    15,    24,    18,    23,    25,    33,    32,     9,    27,
      34,    29,    37,    36
};

static const yytype_uint8 yycheck[] =
{
       4,     8,     0,    14,    15,     3,    13,     6,    12,    11,
       5,     4,    13,     7,     6,     6,    28,     6,    14,     9,
       6,    24,    10,    33
};
...
{
       0,    19,     0,     3,    21,     6,    11,    22,    20,    14,
      15,    23,    24,    30,     5,     4,    27,    28,     7,    25,
       4,    12,    31,     6,    13,     6,    26,     9,    29,    28,
       8,    13,     6,    24,     6,    32,    25,    10
};
...
#line 155 "genpr-parse.y"
    {
	    ...
	    gen_proto ((yyvsp[(2) - (2)].text));
	    gen_prim_decl ((yyvsp[(2) - (2)].text));
	  }
    break;
...
#line 203 "genpr-parse.y"
    {
	    ...
	    filcat ((yyval.fil), (yyvsp[(3) - (3)].text));
	  }
    break;
