...
{
       0,   139,   139,   140,   144,   146,   148,   150,   152,   157,
     160,   164,   173,   184,   184,   190,   191,   194,   197,   196,
     200,   202,   204,   209,   210,   213,   214,   219,   219,   226,
     227,   230,   231,   233,   236,   235,   256,   265,   266,   270,
     271,   275,   275,   288,   289,   293,   294,   298
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 145 "genbc-decl.y"
    { define_bytecode ((yyvsp[(1) - (3)].text), (yyvsp[(2) - (3)].field)); }
    break;

  case 5:
#line 147 "genbc-decl.y"
    { begin_code = (yyvsp[(3) - (4)].text); }
    break;

  case 6:
#line 149 "genbc-decl.y"
    { end_code = (yyvsp[(3) - (4)].text); }
    break;

  case 7:
#line 151 "genbc-decl.y"
    { define_decl ((yyvsp[(1) - (4)].num), (yyvsp[(1) - (4)].num), (yyvsp[(3) - (4)].text)); }
    break;

  case 8:
#line 153 "genbc-decl.y"
    { define_decl ((yyvsp[(1) - (6)].num), (yyvsp[(3) - (6)].num), (yyvsp[(5) - (6)].text)); }
    break;

  case 9:
#line 158 "genbc-decl.y"
...
#line 160 "genbc-decl.y"
  ...
  case 11:
#line 165 "genbc-decl.y"
    { struct field_info *f = malloc (sizeof (struct field_info));
	    define_var ((yyvsp[(3) - (3)].text));
	    f->name = (yyvsp[(3) - (3)].text);
	    f->next = NULL;
	    *((yyvsp[(1) - (3)].field)->pnext) = f;
  ...
  case 12:
#line 174 "genbc-decl.y"
    { struct field_info *f = malloc (sizeof (struct field_info));
	    define_var ((yyvsp[(1) - (1)].text));
	    f->name = (yyvsp[(1) - (1)].text);
	    f->next = NULL;
	    (yyval.field) = f;
	    (yyval.field)->pnext = &(f->next);
	  }
  ...
  case 13:
#line 184 "genbc-decl.y"
    { curr_fil = filnew (NULL, 0); }
    break;

  case 14:
#line 186 "genbc-decl.y"
...
#line 197 "genbc-decl.y"
  ...
  case 19:
#line 199 "genbc-decl.y"
    { filccat (curr_fil, ')'); }
    break;

  case 20:
#line 201 "genbc-decl.y"
    { filcat (curr_fil, (yyvsp[(1) - (1)].text)); free ((yyvsp[(1) - (1)].text)); }
    break;

  case 21:
#line 203 "genbc-decl.y"
    { filprintf (curr_fil, "%d", (yyvsp[(1) - (1)].num)); }
    break;

  case 22:
#line 205 "genbc-decl.y"
    { filcat (curr_fil, (yyvsp[(1) - (1)].ctext)); }
    break;

  case 26:
#line 215 "genbc-decl.y"
    { filccat (curr_fil, ','); }
    break;

  case 27:
#line 219 "genbc-decl.y"
    { curr_fil = filnew (NULL, 0); }
    break;

  case 28:
#line 221 "genbc-decl.y"
    { filcat (curr_fil, "  goto MATCH_BYTECODES_END_##name_; ");
	    (yyval.text) = fildelete (curr_fil); }
    break;

  case 32:
#line 232 "genbc-decl.y"
    { filcat (curr_fil, "goto MATCH_BYTECODES_END_##name_;"); }
    break;

  case 33:
#line 234 "genbc-decl.y"
    { filcat (curr_fil, "goto MATCH_BYTECODES_START_##name_;"); }
    break;

  case 34:
#line 236 "genbc-decl.y"
    { filprintf (curr_fil, "do { \\\n"
				 "\topcode_ = %d; \\\n", synthetic);
	    curr_bytecode = get_bytecode ((yyvsp[(2) - (2)].text));
	    if (!curr_bytecode)
	      {
		curr_field = NULL;
...
#line 248 "genbc-decl.y"
  ...
  case 36:
#line 257 "genbc-decl.y"
    { if ((yyvsp[(2) - (2)].num) % 8)
	      yyerror ("must extract an integer number of bytes");
	    else
	      filprintf (curr_fil, "bp_ = (IP += %d)", (yyvsp[(2) - (2)].num) / 8);
	  }
    break;
...
#line 275 "genbc-decl.y"
  ...
  case 42:
#line 284 "genbc-decl.y"
    { filprintf (curr_fil, "; \\\n"); }
    break;

  case 43:
#line 288 "genbc-decl.y"
    { (yyval.num) = (yyvsp[(2) - (3)].num); }
    break;

  case 44:
#line 289 "genbc-decl.y"
    { (yyval.num) = 8; }
    break;

  case 45:
#line 293 "genbc-decl.y"
    { (yyval.num) = (yyvsp[(1) - (3)].num) + (yyvsp[(3) - (3)].num); }
    break;

  case 46:
#line 294 "genbc-decl.y"
    { (yyval.num) = (yyvsp[(1) - (1)].num); }
    break;

  case 47:
#line 299 "genbc-decl.y"
    { define_field ((yyvsp[(1) - (2)].text), (yyvsp[(2) - (2)].num)); (yyval.num) = (yyvsp[(2) - (2)].num); }
    break;


/* Line 1267 of yacc.c.  */
#line 1650 "genbc-decl.c"
      default: break;
    }
